...
function addVideoToQueue(videoId, playNext = false) {
    console.log(`preload.js sending execute-queue-action to main process: videoId=${videoId}, playNext=${playNext}`);
    ipcRenderer.send('execute-queue-action', { videoId, playNext });
}
